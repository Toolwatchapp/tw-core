...
System.register("directives/clock/clock.component", [], function(exports_12, context_12) {
    "use strict";
...
System.register("directives/login/login.component", ['@angular/core', "directives/global-validator", "services/ga.service", '@angular/forms'], function(exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    var core_7, global_validator_1, ga_service_2, forms_1;
    var LoginComponent;
    return {
        setters:[
            function (core_7_1) {
        ...
        execute: function() {
            ...
            LoginComponent = (function () {
                ...
                function LoginComponent(translate, twapi, formBuilder) {
                    ...
                    this.errors = [];
                    this.userLogged = new core_7.EventEmitter();
                    this.loginAttempt = new core_7.EventEmitter();
...
System.register("directives/signup/signup.component", ['@angular/core', "services/twapi.service", "directives/global-validator", "services/ga.service", '@angular/forms'], function(exports_16, context_16) {
    "use strict";
    var __moduleName = context_16 && context_16.id;
    var core_8, twapi_service_1, global_validator_2, ga_service_3, forms_2;
    var SignupComponent;
    return {
        setters:[
            function (core_8_1) {
            ...
            SignupComponent = (function () {
                ...
                */
                function SignupComponent(translate, twapi, formBuilder) {
                    ...
                    this.signupAttempt = new core_8.EventEmitter();
                    translate.setDefaultLang('en');
                    translate.use('en');
...
System.register("directives/watch/watch.component", ['@angular/core', "models/watch.model", "services/ga.service", '@angular/forms'], function(exports_17, context_17) {
    "use strict";
    var __moduleName = context_17 && context_17.id;
    var core_9, watch_model_3, ga_service_4, forms_3;
    var WatchComponent;
    return {
        setters:[
            function (core_9_1) {
        ...
        execute: function() {
            ...
            WatchComponent = (function () {
                ...
                function WatchComponent(translate, twapi, formBuilder) {
                    ...
                    this.twapi = twapi;
                    this.formBuilder = formBuilder;
                    this.watchSaved = new core_9.EventEmitter();
    ...
    return {
        setters:[
            ...
            function (twapi_service_2_1) {
                exportStar_1(twapi_service_2_1);
            },
